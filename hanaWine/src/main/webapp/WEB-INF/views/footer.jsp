...
<body>
    <footer id="footer">
        ...
        <div class="footer-section footer-social">
            <h2>Social</h2>
            <ul>
                <li><a href="#!"><img src="/Quiz drill/icon/free-icon-telephone-73552.png" alt=""></a></li>
                <li><a href="#!"><img src="/Quiz drill/icon/free-icon-youtube-logo-87421.png" alt=""></a></li>
                <li><a href="#!"><img src="/Quiz drill/icon/free-icon-instagram-4922972.png" alt=""></a></li>
