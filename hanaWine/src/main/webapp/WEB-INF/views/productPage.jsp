...
<header id="header">
	...
	<div id="wrap">
		...
		<div id="RouteArea">
			<span><a href="/" id="mainLink" class="routeLink">HOME</a></span> <span>></span>
			<span><a href="wine" id="subpageLink" class="routeLink">ALL
					WINES</a></span> <span>></span> <span><a href="productPage"
				id="productpageLink" class="routeLink"></a>PRODUCT</span>
		</div>
		...
		<Main id="main" class="dFlex">
			...
			<div class="wineInfo">
				<div id="wineImgArea" style="">
					<img src="<c:url value='/wineimg/${wineProducts.goodsImg}'/>"
						alt="">
				</div>
				<div id="wineDetailArea">
					...
					<ul class="wineDetails">
						...
						<li><strong>원산지:</strong> ${wineProducts.nation} &gt;
							${wineProducts.region}</li>
					...
					<div class="wineRatings">
						...
						<div class="wineRating">
							...
							<div class="ratingBar">
								<div class="ratingFill"
									style="width: ${wineProducts.sweetness*20}%;"></div>
							</div>
							<!-- div.ratingBar -->
						</div>
						<!-- div.wineRating -->
						...
						<div class="wineRating">
							...
							<div class="ratingBar">
								<div class="ratingFill"
									style="width: ${wineProducts.acidity*20}%;"></div>
							</div>
							<!-- div.ratingBar -->
						</div>
						<!-- div.wineRating -->
		...
		<div class="contents productDetail">
			<img class=sizing
				src="<c:url value='/wineimg/${wineProducts.goodsInfo}'/>" alt="">
		</div>
		<div class="contents recommFood" style="display: none;">
			<img class=sizing
				src="<c:url value='/wineimg/${wineProducts.recipe}'/>" alt="">
		</div>
		...
		<div class="contents qa" style="display: none;">
			<iframe id="qaIframe" src="http://localhost/faq_listsub"
				title="자주뭍는질문"> </iframe>
		</div>
