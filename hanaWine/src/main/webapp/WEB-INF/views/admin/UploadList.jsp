...
<c:choose>
	...
	<div id="main" class="dFlex">
		<div id="wineUpload">
			<h1>와인 등록</h1>
			<form action="/insert" name="wineInsert" method="post"
				...
				<table id="Regtable">
					<tbody>
						...
						<tr>
							<th>추천음식</th>
							<td><input type="checkbox" value="1" name="foodIdx">Beaf
								<input type="checkbox" value="2" name="foodIdx">cheese <input
								type="checkbox" value="3" name="foodIdx">Lamb <input
								type="checkbox" value="4" name="foodIdx">Pasta</td>
						</tr>
						<tr class="regBtn">
							<td colspan="2">
