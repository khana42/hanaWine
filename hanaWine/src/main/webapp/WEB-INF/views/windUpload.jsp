...
<body>
   <div id="wineUpload">
      <h1>와인 등록</h1>
      <a href="wineList" id="wineList">
      	<img src="/img/logo.png" alt="관리자페이지로">
      </a>
      ...
      <form action="/insert" method="post" enctype="multipart/form-data">
         <table id="Regtable">
            <tbody>
               ...
               <tr>
                  <th>추천음식</th>
                  <td><input type="radio" value="Beaf">Beaf <input
                     type="radio" value="cheese">cheese <input type="radio"
                     value="Lamb">Lamb <input type="radio" value="Pasta">Pasta
                  </td>
               </tr>
               <tr class="regBtn">
                  <td colspan="2">
