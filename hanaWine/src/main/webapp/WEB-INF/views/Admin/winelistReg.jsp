		  ...
		  <form action="/winelistReg" method="post" enctype="multipart/form-data">
			<table id="Regtable">
				<tbody>
					...
					<tr>
                        <th>도수</th>
                        <td><input type="text" name="alcohol" pattern="[0-9]+" required></td>
                   </tr>
                   	<tr>
                       <th>당도</th>
                       <td><input type="text" name="sweetness" pattern="[0-9]+" required></td>
                   </tr>
                  	<tr>
                        <th>산도</th>
                        <td><input type="text" name="acidity" pattern="[0-9]+" required></td>
                  	</tr>
                    <tr>
                        <th>바디</th>
                        <td><input type="text" name="body" pattern="[0-9]+" required></td>
                    </tr>
					<tr>
						<th>상품 이미지</th>
